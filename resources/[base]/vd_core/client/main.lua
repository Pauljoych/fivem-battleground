...
AddEventHandler('esx:playerLoaded', function(xPlayer, isNew, skin)
	...
	if Config.Multichar then
		...
		exports.spawnmanager:spawnPlayer({
			...
			-- TriggerEvent('vd_skin:playerRegistered')
...
AddEventHandler("esx:tpm", function()
	...
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		...
		if not DoesBlipExist(blipMarker) then
			...
			ESX.ShowNotification("INFO", "Tandain dulu masbroo", 2000, 'info')
			return 'marker'
		end
		...
		if not found then
			...
			ESX.ShowNotification("INFO", "Teleport Success!", 2000, 'success')
		end
...
AddEventHandler("esx:noclip", function(input)
	ESX.TriggerServerCallback("esx:isUserAdmin", function(admin)
		...
		ESX.ShowNotification("INFO", "Noclip!", 2000, 'success')
	end)
end)

...
function ESX.ShowNotification(hehe, message, time, tipe)
    exports['vd-notif']:Alert(hehe, message, time, tipe)
end
                                    ...
                                    if type == 'item_weapon' then
                                        ...
                                        ESX.OpenContext("right", elementsG, function(menuG,elementG)
                                            ...
                                            if quantity and quantity > 0 and element.count >= quantity then
                                                ...
                                                ESX.ShowNotification("INFO", "Invalid quantity!", 2000, 'error')
                                            end
                                        end)
                                    end
                                else
                                    -- ESX.ShowNotification(TranslateCap('in_vehicle'))
                                    ESX.ShowNotification("INFO", "Berada di Kendaraan!", 2000, 'error')
                                end
                            else
...
--     ESX.ShowNotification("INFO", msg, length, type)
-- end)

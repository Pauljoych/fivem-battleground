ESX.RegisterCommand('tp', 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        name = 'x',
        help = TranslateCap('command_setcoords_x'),
        type = 'number'
    }, {
        name = 'y',
        help = TranslateCap('command_setcoords_y'),
        type = 'number'
    }, {
        name = 'z',
        help = TranslateCap('command_setcoords_z'),
        type = 'number'
    }}
})
...
ESX.RegisterCommand('setjob', 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        name = 'playerId',
        help = TranslateCap('commandgeneric_playerid'),
        type = 'player'
    }, {
        name = 'job',
        help = TranslateCap('command_setjob_job'),
        type = 'string'
    }, {
        name = 'grade',
        help = TranslateCap('command_setjob_grade'),
        type = 'number'
    }}
})
...
ESX.RegisterCommand('car', 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        name = 'car',
        validate = false,
        help = TranslateCap('command_car_car'),
        type = 'string'
    }}
})
...
ESX.RegisterCommand({'cardel', 'dv'}, 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        name = 'radius',
        validate = false,
        help = TranslateCap('command_cardel_radius'),
        type = 'number'
    }}
})
...
ESX.RegisterCommand('setaccountmoney', 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        ...
        name = 'account',
        help = TranslateCap('command_giveaccountmoney_account'),
        type = 'string'
    }, {
        name = 'amount',
        help = TranslateCap('command_setaccountmoney_amount'),
        type = 'number'
    }}
})
...
ESX.RegisterCommand('giveaccountmoney', 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        ...
        name = 'amount',
        help = TranslateCap('command_giveaccountmoney_amount'),
        type = 'number'
    }}
})
...
if not Config.OxInventory then
    ESX.RegisterCommand('giveitem', 'admin', function(xPlayer, args, showError)
        ...
        arguments = {{
            ...
            name = 'item',
            help = TranslateCap('command_giveitem_item'),
            type = 'item'
        }, {
            name = 'count',
    ...
    ESX.RegisterCommand('giveweapon', 'admin', function(xPlayer, args, showError)
        ...
        arguments = {{
            ...
            name = 'weapon',
            help = TranslateCap('command_giveweapon_weapon'),
            type = 'weapon'
        }, {
            name = 'ammo',
            help = TranslateCap('command_giveweapon_ammo'),
            type = 'number'
        }}
    })
    ...
    ESX.RegisterCommand('giveammo', 'admin', function(xPlayer, args, showError)
        ...
        arguments = {{
            ...
            name = 'weapon',
            help = TranslateCap('command_giveammo_weapon'),
            type = 'weapon'
        }, {
            name = 'ammo',
...
ESX.RegisterCommand('setgroup', 'admin', function(xPlayer, args, showError)
    ...
    arguments = {{
        ...
        name = 'group',
        help = TranslateCap('command_setgroup_group'),
        type = 'string'
    }}
})
...
ESX.RegisterCommand('saveall', 'admin', function(xPlayer, args, showError)
    ...
    help = TranslateCap('command_saveall')
})

...
function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, loadout, name, coords)
	...
	function self.addInventoryItem(name, count, metadata, slot)
		...
		if item then
			...
			TriggerClientEvent('dream-inventory:notification',self.source, "RECEIVED", item.name, item.label, count)	
		end
	end
	...
	function self.removeInventoryItem(name, count, metadata, slot)
		...
		if item then
			...
			if newCount >= 0 then
				...
				TriggerClientEvent('dream-inventory:notification',self.source, "REMOVED", item.name, item.label, count)
			end
		end
	end
	...
	function self.addWeapon(weaponName, ammo)
		if not self.hasWeapon(weaponName) then
			...
			TriggerClientEvent('dream-inventory:notification',self.source, "RECEIVED", weaponName, weaponLabel, '1')
		end
	end
	...
	function self.removeWeapon(weaponName)
		...
		if weaponLabel then
			...
			TriggerClientEvent('dream-inventory:notification',self.source, "REMOVED", weaponName, weaponLabel, '1')
		end
	end

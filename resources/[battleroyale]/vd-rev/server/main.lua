...
TriggerEvent('esx_service:activateService', 'ambulance', -1)

RegisterServerEvent('esx_ambulancejob:menghidupkan')
AddEventHandler('esx_ambulancejob:menghidupkan', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_ambulancejob:menghidupkan', target)
end)
...
ESX.RegisterServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function(source, cb)
	local src = source
	local xPlayer = ESX.GetPlayerFromId(source)
	DropPlayer(src, 'KEHABISAN WAKTU REVIVE')
...
ESX.RegisterCommand('revive', 'admin', function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx_ambulancejob:menghidupkan')
...
-- 	TriggerClientEvent('esx_ambulancejob:menghidupkan', -1)
-- end, false)

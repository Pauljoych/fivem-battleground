local botToken <const> = "MTAxODExOTc4MTA1ODEwNTM0NA.GJwWKk.P9SNv4uzAxXPYyyll3VfiHnq14JC2iGoNyiIxE" -- Add your discord bot with admin perms token here.
...
local DEFAULT_ID <const> = '1013768715948527627' -- Just in case the player doesn't have discord open
...
RegisterNetEvent('ev:playerSet', function()
    ...
    -- if license then
        ...
        if avatar == nil then
            avatar = 'https://media.discordapp.net/attachments/935119538779979797/1080792275900186644/image.png'
        end
        if playerData then
            return
        end
...
RegisterCommand('topkill', function(source)
    local playerId <const> = source
    local data = {}
